...
- `heroai_combat_handover.md` is a performance and decision-pipeline handover;
  verify its optimization claims against current `HeroAI/` and routine sources.
- `HeroAi_interrupt_feasibility.md` documents the two evaluator gates, logging,
...
- `HeroAI_UI_inventory.md` inventories overlapping HeroAI UI surfaces for
...
- `Follower_resolves_unstuck.md` documents the per-follower smart-unstuck
