...
`BottingTree` and `RoutinesBT` are both built on top of the core `BehaviorTree` framework in [BehaviorTree.py](../../../Py4GWCoreLib/py4gwcorelib_src/BehaviorTree.py).
...
- `C:\Users\Apo\Py4GW_python_files\Presearing Dominator.py` (legacy parity reference)
  - long-form planner
  - named sequence restart
  - upkeepers
  - path overlay drawing

- `C:\Users\Apo\Py4GW_python_files\Absolute Pre-Searing.py` (legacy parity reference)
...
- `C:\Users\Apo\Py4GW_python_files\botting_tree_template.py` (legacy parity reference)
  - minimal wrapper setup

- [HeroAI_ParallelTree_Example.py](../../../HeroAI_ParallelTree_Example.py)
