...
- `bottingtree_and_bt_routines_guide.md` describes the current relationship
  between `BehaviorTree`, `RoutinesBT`, `BottingTree`, and `ApoSource` wrappers.
- `behavior_tree_metadata_preparation_guide.md` records the metadata contract
  prepared for discovery/configurator tooling without redesigning runtime
  execution.
- `bot_factory_session_design.md` records the bot-authoring/configurator
