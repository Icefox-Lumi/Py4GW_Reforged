...
Current-source note (reviewed 2026-08-04): the live sources are under
`Py4GWCoreLib/database_src/` and `Py4GWCoreLib/Database.py`. The legacy-path
links that were present in this document have been replaced with links to the
current tree; use `DBMGR_HANDOVER.md` only as historical design context.
...
- [Py4GWCoreLib/database_src/DBMgr.py](../../../Py4GWCoreLib/database_src/DBMgr.py)
...
- [Py4GWCoreLib/Database.py](../../../Py4GWCoreLib/Database.py)
...
- [Py4GWCoreLib/database_src/Account.py](../../../Py4GWCoreLib/database_src/Account.py)
