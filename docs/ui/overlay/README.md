...
- `overlay_3d_performance_issues.md` is a troubleshooting/postmortem record,
...
- The unresolved `PF-5` item is tracked in
  `docs/architecture/project_records/pending_fixes.md`; keep the
...
3. Consult `docs/architecture/project_records/pending_fixes.md` for the
