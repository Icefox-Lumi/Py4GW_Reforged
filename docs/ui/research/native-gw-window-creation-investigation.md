...
- `docs/cpp-wasm-mapping.md` is the required bridge workflow when promoting WASM findings into C++.
...
### Pass 4: EXE bridge promotion via `cpp-wasm-mapping.md`
Focus:
...
See `docs/ui/research/window-creation-architecture.md` for the updated canonical API reference.
