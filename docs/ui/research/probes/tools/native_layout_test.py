...
Hypothesis under test (docs/ui/research/native-dialog-layout-process.md):
...
interact, then CLOSE VIA THE NATIVE [X] and watch for a crash. Crash-safe log at UI_RE/native-layout-log.txt
...
LOG_PATH = os.path.join(_BASE, "native-layout-log.txt")
