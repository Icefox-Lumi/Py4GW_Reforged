...
diff --git a/docs/native-ui-title-and-encoded-string-reference.md b/docs/native-ui-title-and-encoded-string-reference.md
new file mode 100644
--- /dev/null
+++ b/docs/native-ui-title-and-encoded-string-reference.md
@@ -0,0 +1,523 @@
