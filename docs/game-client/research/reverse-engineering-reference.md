...
- See `cpp-wasm-mapping.md` for the full CPP↔WASM↔EXE translation procedure and worked examples.
...
Full procedure in: `docs/game-client/research/cpp-wasm-mapping.md`
...
- `docs/game-client/research/packet-sniffers-reference.md`
...
Use string anchoring (see cpp-wasm-mapping.md) or byte patterns.
...
| `CContainerFrame::FrameProc` | `0x00871b40` | (`reverse-engineering-reference.md` Section 10) |
...
All files in `docs/game-client/research/`:

| File | Content |
|------|---------|
| `README.md` | Index of RE documents by purpose |
| `reverse-engineering-reference.md` | This file - canonical library reference and interface guide |
...
→ **`docs/game-client/research/map-travel-reverse-engineering.md`**
...
All 20 stages confirmed in WASM as of 2026-06-12. See `docs/game-client/research/map-travel-reverse-engineering.md` §12 for full table.
