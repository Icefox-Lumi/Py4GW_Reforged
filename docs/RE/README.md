...
| `name_tag_color/Reverse_Engineering.md` | Preserved agent/item name-tag color RE and historical `PyAgentTagColor` detour record; current source uses `PyAgentRecolor` | Native name-tag recoloring |
