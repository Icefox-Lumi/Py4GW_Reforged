...
- `agents-merged-sources.md` is the generic merged-source version based on the public Codex and OpenCode files.
- `agents-py4gw.md` is the Py4GW-adapted version, combining the same structural basis with the project's actual domain context.
