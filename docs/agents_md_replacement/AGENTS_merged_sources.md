...
<!--
Primary source: sources/source_codex_default.md, AGENTS.md spec.
Repository-context source: sources/source_codex_AGENTS.md.
Prompt-variant sources: sources/source_opencode_codex.txt and sources/source_opencode_anthropic.txt.
...
<!--
Sources:
- [Codex-base] sources/source_codex_default.md
- [OpenCode-Anthropic] sources/source_opencode_anthropic.txt
- [OpenCode-Codex] sources/source_opencode_codex.txt
-->
...
Sources:
- [Codex-base] sources/source_codex_default.md
- [Codex-repo] sources/source_codex_AGENTS.md
- [OpenCode-Codex] sources/source_opencode_codex.txt
-->
