...
Decide items in §5 (especially #1 and #2) before any code. Once framing is chosen, the coverage matrix (`coverage-matrix.md`) becomes the work backlog and the backend inventory (`backend-surface.md`) becomes the completeness checklist.
