...
For the full explicit architecture model, use
[Py4GW_Conceptual_Model.md](../../architecture/conceptual_model/Py4GW_Conceptual_Model.md).
...
- `docs/architecture/conceptual_model/Py4GW_Conceptual_Model.md` is the current source-of-truth for the conceptual architecture.
