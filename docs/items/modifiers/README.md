...
| [`item-catalogs.md`](item-catalogs.md) | **The whole universe** — all 8 static item catalogs (colors/attributes/descriptions/formulas/elements/books/PvP items/PvP mods) dumped to `catalogs/*.csv` + `raw-item-catalogs.json`, with addresses, counts, and remaining passes. |
