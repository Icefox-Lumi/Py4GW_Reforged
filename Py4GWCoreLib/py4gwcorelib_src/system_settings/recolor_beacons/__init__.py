...
It **consumes**: filters and filter sets from the Loot Filter Factory, beacon presets from the Beacons
...
__all__ = ["RecolorBeacons", "MarkConfig", "MarkOutcome", "BLANK_ARGB"]