...
class IdentificationProfile:
    """Reserved independent filter state for the future identification feature."""
    ...
    @staticmethod
    def from_dict(raw: Any) -> "IdentificationProfile":
        return IdentificationProfile(list(raw.get("excluded", [])) if isinstance(raw, dict) else [])
...
class ItemProfile:
    name: str = "Default"
    identification: IdentificationProfile = field(default_factory=IdentificationProfile)
    ...
    def from_dict(raw: Any) -> "ItemProfile":
        ...
        return ItemProfile(
            ...
            identification=IdentificationProfile.from_dict(raw.get("identification")),
