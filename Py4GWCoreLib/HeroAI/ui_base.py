...
from .utils import DrawFlagAll, DrawHeroFlag, IsHeroFlagged
from .windows import HeroAI_FloatingWindows, HeroAI_Windows
from .constants import MAX_NUM_PLAYERS, NUMBER_OF_SKILLS

from .constants import (FOLLOW_DISTANCE_OUT_OF_COMBAT, MAX_NUM_PLAYERS, MELEE_RANGE_VALUE, PARTY_WINDOW_FRAME_EXPLORABLE_OFFSETS,
...
class HeroAI_BaseUI:
    ...
    ButtonColors = {
        ...
        "Celerity": ButtonColor(button_color=Color(129, 33, 188, 255), hovered_color=Color(165, 100, 200, 255), active_color=Color(135, 225, 230, 255), texture_path="Assets\\Textures\\Consumables\\Trimmed\\Essence_of_Celerity.png"),
        "GrailOfMight": ButtonColor(button_color=Color(70, 0, 10, 255), hovered_color=Color(160, 0, 15, 255), active_color=Color(252, 225, 115, 255), texture_path="Assets\\Textures\\Consumables\\Trimmed\\Grail_of_Might.png"),
        "ArmorOfSalvation": ButtonColor(button_color=Color(96, 60, 15, 255), hovered_color=Color(187, 149, 38, 255), active_color=Color(225, 150, 0, 255), texture_path="Assets\\Textures\\Consumables\\Trimmed\\Armor_of_Salvation.png"),
        "CandyCane": ButtonColor(button_color=Color(63, 91, 54, 255), hovered_color=Color(149, 72, 34, 255), active_color=Color(96, 172, 28, 255), texture_path="Assets\\Textures\\Consumables\\Trimmed\\Rainbow_Candy_Cane.png"),
        "BirthdayCupcake": ButtonColor(button_color=Color(138, 54, 80, 255), hovered_color=Color(255, 186, 198, 255), active_color=Color(205, 94, 215, 255), texture_path="Assets\\Textures\\Consumables\\Trimmed\\Birthday_Cupcake.png"),
        "GoldenEgg": ButtonColor(button_color=Color(245, 227, 143, 255), hovered_color=Color(253, 248, 234, 255), active_color=Color(129, 82, 35, 255), texture_path="Assets\\Textures\\Consumables\\Trimmed\\Golden_Egg.png"),
        "CandyCorn": ButtonColor(button_color=Color(239, 174, 33, 255), hovered_color=Color(206, 178, 148, 255), active_color=Color(239, 77, 16, 255), texture_path="Assets\\Textures\\Consumables\\Trimmed\\Candy_Corn.png"),
        "CandyApple": ButtonColor(button_color=Color(75, 26, 28, 255), hovered_color=Color(202, 60, 88, 255), active_color=Color(179, 0, 39, 255), texture_path="Assets\\Textures\\Consumables\\Trimmed\\Candy_Apple.png"),
        "PumpkinPie": ButtonColor(button_color=Color(224, 176, 126, 255), hovered_color=Color(226, 209, 210, 255), active_color=Color(129, 87, 54, 255), texture_path="Assets\\Textures\\Consumables\\Trimmed\\Slice_of_Pumpkin_Pie.png"),
        "DrakeKabob": ButtonColor(button_color=Color(28, 28, 28, 255), hovered_color=Color(190, 187, 184, 255), active_color=Color(94, 26, 13, 255), texture_path="Assets\\Textures\\Consumables\\Trimmed\\Drake_Kabob.png"),
    ...
    def _refresh_team_viewer_rows(cached_data: CacheData) -> None:
        ...
        from . import team_viewer_broadcast
        ...
        if ImGui.Begin(ini_key=cached_data.ini_key, name="HeroAI Build Matches", p_open=True, flags=PyImGui.WindowFlags.NoFlag):
            if PyImGui.begin_tab_bar("HeroAIBuildMatchTabs"):
                ...
                if PyImGui.begin_tab_item("Hex Removal"):
                    from .hex_removal_src.hex_removal_ui import draw_tab as _draw_hex_removal_tab
    ...
    def _load_follow_runtime_config(ini_key: str):
        ...
        from .follow.smart_unstuck import SMART_UNSTUCK_CFG
    ...
    def DrawFollowFormationsQuickWindow(cached_data: CacheData):
        ...
        if HeroAI_BaseUI.show_follow_formations_quick_window:
            if ImGui.Begin(ini_key=cached_data.formation_window_ini_key, name="Follow Formations Quick Settings", p_open=True, flags=PyImGui.WindowFlags.AlwaysAutoResize):
                ...
                if PyImGui.button(editor_label):
                    ...
                    if HeroAI_BaseUI.show_follow_formations_editor_window:
                        from .follow.editor import open_editor
                        open_editor()
            ...
            from .follow.smart_unstuck import (
                SMART_UNSTUCK_CFG,
        ...
        if HeroAI_BaseUI.show_follow_formations_editor_window:
            import Py4GW
            try:
                from .follow.editor import main as draw_follow_formations_editor
