...
def _load_mode_setting(bot: Botting) -> None:
    ...
    try:
        _combat_backend = int(cfg.get_int(_SETTINGS_SECTION, _COMBAT_BACKEND_KEY, _combat_backend))
    except Exception:
        _combat_backend = 0
...
def _save_mode_setting(bot: Botting) -> None:
    ...
    cfg.set(_SETTINGS_SECTION, _COMBAT_BACKEND_KEY, int(_combat_backend))
