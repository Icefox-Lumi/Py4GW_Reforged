...
def Unlock_Eye_Of_The_North_Pool(bot: Botting):
    ...
    bot.Wait.ForTime(1000)
    bot.Dialogs.WithModel(5959, 0x63D) # Eotn_pool_cinematic. Model id updated 20.12.2025 GW Reforged
    bot.Wait.ForTime(1000)
    bot.Dialogs.WithModel(5959, 0x63F) # Eotn_pool_cinematic. Model id updated 20.12.2025 GW Reforged
    bot.Wait.ForTime(1000)
    bot.Wait.ForMapToChange(target_map_id=646)
