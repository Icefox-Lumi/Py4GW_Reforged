...
L3_FENDI_PATH = [
    Vec2f(-8696, 6323),Vec2f(-9988, 7652), Vec2f(-12712.36, 13502.19),
]
...
def Level3_Chest() -> BehaviorTree:
    return BT.Sequence(
        ...
        children=[
            ...
            # Controlled loot pass: first wait for a safe OFF window using
            # NameProperties bit 0x8000. If that wait expires, force the pickup
            # with geyser state ignored: the objective remains to loot the final chest.
            SafeLootFendiChest(),
