...
from Sources.frenkeyLib.item_mods_src.types import ItemBaneSpecies, ItemUpgradeType, ModifierIdentifier
from Sources.frenkeyLib.item_mods_src.upgrades import Upgrade, UnknownUpgrade, _UPGRADES
