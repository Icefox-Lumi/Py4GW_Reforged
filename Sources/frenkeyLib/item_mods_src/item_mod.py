...
from Sources.frenkeyLib.item_mods_src.properties import BowTypeProperty, InherentProperty, InscriptionProperty, ItemProperty, PrefixProperty, SuffixProperty, TargetItemTypeProperty
...
class ItemMod:
    ...
    def get_item_upgrades(item_id : int) -> tuple[Upgrade | None, Upgrade | None, Upgrade | None, list[Upgrade] | None]:
        ...
        runtime_modifiers = Item.Mods.GetModifiers(item_id)
