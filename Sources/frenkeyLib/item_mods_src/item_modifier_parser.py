...
from Sources.frenkeyLib.item_mods_src.properties import InherentProperty, InscriptionProperty, ItemProperty, PrefixProperty, SuffixProperty
...
class ItemModifierParser:
    ...
    def _build_properties(self):
        from Sources.frenkeyLib.item_mods_src.upgrades import _INHERENT_UPGRADES
